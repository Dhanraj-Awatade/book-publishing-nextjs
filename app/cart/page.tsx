...
const Page = () => {
    ...
    const [selectedAddress, selectAddress] = useState<
        ...
        | null
        | undefined
    >(/*addresses && addresses.at(0) ? addresses.at(0) :*/ null);
    ...
    const cartMrpTotal = items.reduce(
        (total, { product, productCount }) =>
            total + product.mrp * productCount,
        0
    );
    const totalItems = items.reduce(
        (total, { productCount }) => total + productCount,
        0
    );
    const [shippingCharges, setShippingCharges] = useState<number>(
        /*isAnyPaperback ? SHIPPING_CHARGES * totalItems :*/ 0
    );
        ...
        <div className="bg-white">
                ...
                <div className="mt-12 lg:grid lg:grid-cols-12 lg:items-start lg:gap-x-12 xl:gap-x-16">
                    <div
                        className={cn("lg:col-span-7", {
                            "rounded-lg border-2 border-dashed border-zinc-200 p-12 lg:col-start-3":
            ...
            >
                ...
                <p className="text-amber-700">
                    Please do not go back or refresh this page
                </p>
            </div>
        </div>
    );
