...
const Orders = () => {
    ...
    const { data, isLoading, error, isError } = trpc.productProcedures.getOrders.useQuery({ cursor }, {
                ...
                <div className='max-w-7xl w-full mx-auto flex flex-col sm:gap-4 sm:py-4'>
                    <div className='flex flex-col gap-16'>
                        ...
                        <div className='w-full mb-3'>
                            ...
                            {isLoading ? <div className='flex flex-col w-full items-center justify-center'>
                                ...
                                : <Table>
                                    ...
                                    <TableBody>
                                        {(/*user.role === "customer" ? userOrders :*/ orders)?.map((order) => (
                    ...
                    <div className='flex items-center justify-center gap-x-4'>
                        <Button
                            ...
                            onClick={() => setCursor(hasPrevPage && prevPage ? prevPage : 1)}
                        >
                        ...
                        <Button
                            ...
                            onClick={() => setCursor(hasNextPage && nextPage ? nextPage : 1)}
                        >
