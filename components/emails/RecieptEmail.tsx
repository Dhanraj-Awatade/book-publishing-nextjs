...
import { Html, Preview, Body, Container, Img, Text, Column, Head, Hr, Section, Button, Row, Link, render } from '@react-email/components'
...
export const RecieptEmailHtml = (
    props: RecieptEmailProps
