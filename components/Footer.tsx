...
const Footer = () => {
    ...
    return (
        <footer className='bg-gray-200 flex-grow-0'>
            <MaxWidthWrapper>
                <div className='border-t border-gray-200'>
                    <div className='flex justify-between'>
                        ...
                        {/* <div className='border-t border-gray-700 w-2 h-full'></div> */}
                        {
                            pathToMinimize.includes(pathname) ? null : (
                                <div className='mt-10'>
                                    <div className='relative flex items-center px-6 py-6 sm:py-8 lg:mt-0'>
                                        ...
                                        <div className='text-center relative mx-auto max-w-sm'>
                                            ...
                                            <p className=' text-sm text-muted-foreground'>Want to publish your own books?{' '}</p>
                                            <Link href="/sign-in?as=seller" className='whitespace-nowrap font-medium text-rose-600 hover:text-gray-900'>Publish Here &rarr;</Link>
                                        </div>
                                    </div>
                                </div>
                            )
